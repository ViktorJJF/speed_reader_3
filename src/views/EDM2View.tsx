...
const EDM2View: React.FC = () => {
  ...
  return (
    <div>
      <PageHeader>EDM2 - Memoria eidética. 4 dígitos</PageHeader>
      <StyledCard>
        <Controls>
          <ControlGroup>
            <div>
            ...
            {!showResults ? (
              showInputs ? (
                <Button
                  ...
                  disabled={!input1 || !input2 || input1.length < 2 || input2.length < 2}
                >
                  Corregir
                </Button>
              ) : (
