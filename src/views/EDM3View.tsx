...
const EDM3View: React.FC = () => {
  ...
  const handleVerifyClick = () => {
    const isAnswerCorrect = input1 === numbers[0] && input2 === numbers[1];
  ...
  return (
    <div>
      <PageHeader>EDM3 - Memoria eidética. 6 dígitos</PageHeader>
      <StyledCard>
        <Controls>
          <ControlGroup>
            <div>
            ...
            {!showResults ? (
              showInputs ? (
                <Button
                  ...
                  disabled={!input1 || !input2 || input1.length < 3 || input2.length < 3}
                >
                  Corregir
                </Button>
              ) : (
