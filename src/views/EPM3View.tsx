...
const EPM3View: React.FC = () => {
  ...
  return (
    <div>
      <PageHeader>EPM3 - Artículo, sustantivo y adjetivo</PageHeader>
      <StyledCard>
        <Controls>
          <ControlGroup>
            <div>
        ...
        <Canvas>
          {showWords && (
            <WordContainer>
              <span>{WORD_PAIRS[currentIndex].article}</span>
